...
class NewsSiteSport extends Component{
    state ={data:{},
  search:{},
};
 ...
 async fetchData(){
   ...
   let response= await http.get(`?&api-key=3b4d4934-082c-4288-b1d1-67707f4fd8b8&q=sport?${searchStr}`);
