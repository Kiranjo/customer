...
class BookAppHarry extends Component{
    state={
        data:{},
        startIndex:0,
        maxResult:0,
    ...
    async fetchData(){
        ...
        let response= await http.get(`?q=Harry Potter&${searchStr}`);
        ...
        <div className="col-9">
          ...
          {items2.map((itm,index)=>(
            <div className="col-3 border bg-success">
              <img src={itm.imageLinks.thumbnail}></img>
