...
class BookAppPrem extends Component{
    state={
        data:{},
        startIndex:0,
        maxResult:0,
    ...
    async fetchData(){
        ...
        let response= await http.get(`?q=Premchand&${searchStr}`);
    ...
    render(){
      ...
      <div className="row">
        ...
        <div className="col-9">
            <h3 className="text-warning text-center">Premchand Books</h3>
