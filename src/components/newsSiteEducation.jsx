...
class NewsSiteEducation extends Component{
    state ={data:{},
  search:{},
};
...
async fetchData(){
  ...
  // let {page="1"}=queryParams;
   let response= await http.get(`?&api-key=3b4d4934-082c-4288-b1d1-67707f4fd8b8&q=education?${searchStr}`);
...
makeSearchString=(options)=>{
 ...
 `${paramName}=${paramValue}`:str;
  ...
  console.log(results);
  let results1=results.filter((res)=>res.sectionName=="Education");
...
export default NewsSiteEducation;